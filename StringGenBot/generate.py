...
buttons_ques = [
    [
        InlineKeyboardButton("ᴘʏᴘᴏɢʀᴀᴍ", callback_data="pyrogram1"),
        InlineKeyboardButton("ᴘʏᴘᴏɢʀᴀᴍ ᴠ2", callback_data="pyrogram"),
    ],
    [
        InlineKeyboardButton("ᴛᴇʟᴇᴛʜᴏɴ", callback_data="telethon"),
    ],
    [
        InlineKeyboardButton("ᴘʏᴘᴏɢʀᴀᴍ ʙᴏᴛ", callback_data="pyrogram_bot"),
...
gen_button = [
    [
        InlineKeyboardButton(text=" ɢᴇɴᴇʀᴛᴀᴇ sᴛʀɪɴɢ ", callback_data="generate")
    ]
]
...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    if is_bot:
        ty += " ʙᴏᴛ"
    await msg.reply(f"» ᴛʏᴘɪɴɢ ᴛᴏ sᴛᴀʀᴛ **{ty}** sᴇssɪᴏɴ ɢᴇɴᴇʀᴀᴛᴏʀ...")
    user_id = msg.chat.id
    api_id_msg = await bot.ask(user_id, "ᴘʟᴇᴀsᴇ sᴇɴᴅ ʏᴏᴜʀ **ᴀᴘɪ_ɪᴅ** ᴛᴏ ᴘʀᴏᴄᴇᴇᴅ.\n\nᴄʟɪᴄᴋ ᴏɴ  /skip ғᴏʀ ᴜsᴇɪɴɢ ʙᴏᴛ ᴀᴘɪ.", filters=filters.text)
    ...
    if api_id_msg.text == "/skip":
        ...
        try:
            ...
            return
        api_hash_msg = await bot.ask(user_id, "» ɴᴏᴡ ᴘʟᴇᴀsᴇ ʏᴏᴜʀ  **ᴀᴘɪ_ʜᴀsʜ** ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ", filters=filters.text)
        if await cancelled(api_hash_msg):
            return
        api_hash = api_hash_msg.text
    if not is_bot:
        t = "» ᴘʟᴇᴀsᴇ sᴇɴᴅ ʏᴏᴜʀ  **ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ** ᴡɪᴛʜ ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇғᴏʀ ᴡɪʜᴄʜ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ sᴇssɪᴏɴ  \nᴇxᴀᴍᴘʟᴇ : `+910000000000`'"
    else:
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ  :** @The_StringRobot\n **ɴᴏᴛᴇ :** ᴅᴏɴᴛ sʜᴀʀᴇ ᴡɪᴛʜ ᴀɴʏᴏɴᴇ ʙᴇᴀᴄᴀᴜsᴇ ʜᴇ ᴄᴀɴ ʜᴀᴄᴋ ʏᴏᴜʀ ᴀʟʟ ᴅᴀᴛᴀ .  ᴀɴᴅ ᴅᴏɴᴛ ғᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @FRIENDS2FAMILY_0 & @The_F2F_Shayri "
    try:
        if not is_bot:
    ...
    await bot.send_message(msg.chat.id, " sᴜᴄᴄᴇssғᴜʟʟʏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʏᴏᴜ {} sᴛʀɪɴɢ sᴇssɪᴏɴ.\n\nᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴀᴠᴇᴅ ᴍᴇssᴀɢᴇ ᴛᴏ ɢᴇᴛ ɪᴛ ! \n\nᴀ sᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ ʙʏ  @ᴘᴍ_ʏᴛʙᴏᴛ ".format("ᴛᴇʟᴇᴛʜᴏɴ" if telethon else "ᴩʏʀᴏɢʀᴀᴍ"))
...
async def cancelled(msg):
    if "/cancel" in msg.text:
        ...
        await msg.reply("**ᴄᴀɴᴄʟʟᴇᴅ ᴛʜᴇ ᴏɴ ɢᴏɪɴɢ sᴛʀɪɴɢ sᴇssɪᴏɴ ɢᴇɴᴇʀᴀᴛɪɴɢ ᴘʀᴏᴄᴇss !**", quote=True)
        return True
    else:
        return False
